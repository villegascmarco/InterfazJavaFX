                           ...
                           ResourceBundle rb)
    {
        ...
        try
        {
            ...
            tblSucursales.setOnKeyReleased(x -> 
            {
                ...
                {
                    Logger.getLogger(PaneSucursalesControlador.class.getName()).log(
            ...
            btnEliminar.setOnAction(evt -> 
            {
                if (tblSucursales.getSelectionModel().getSelectedItem() != null)
                    ...
                    {
                        Logger.getLogger(
                                PaneSucursalesControlador.class.getName()).log(
                                Level.SEVERE, null, ex);
                    }
            });
...
//                    nuevo = 2;
            ...
            throws UnsupportedEncodingException, Exception
    {
        ...
        stage.getIcons().add(new Image(this.getClass().getResource(
                "/res/lotus.png").toString()));

        a.setTitle("Aviso");
        a.setHeaderText(null);
        a.setContentText(
                "¿Está seguro que desea eliminar " + txtNombre.getText() + "?");
        ...
        if (result.get() == ButtonType.OK)
        {
            ...
            String id = URLEncoder.encode(String.valueOf(su.getIdSucursal()),
                    "UTF-8");
            ...
            windowmain.mostrarNotificacion("Alerta",
                    "Sucursal " + su.getNombre() + " eliminada",
        ...
        if (nuevo > 0)
            ...
            switch (nuevo)
            {
                case 2:
                {
                    ...
                    Sucursal su = new Sucursal();
                    su = tblSucursales.getSelectionModel().getSelectedItem();
                    String id = URLEncoder.encode(String.valueOf(
                            su.getIdSucursal()), "UTF-8");
                    String nom = URLEncoder.encode(txtNombre.getText(), "UTF-8");
                    String dom = URLEncoder.encode(txtDomicilio.getText(),
                            "UTF-8");
                    String lat = URLEncoder.encode(txtLatitud.getText(), "UTF-8");
                    String lon = URLEncoder.encode(txtLongitud.getText(),
                            "UTF-8");
                    ...
                    windowmain.mostrarNotificacion("Aviso",
                            "¡Actualización exitósa!", NotificationType.SUCCESS);
                    Platform.runLater(() -> 
                    {
                        try
                        {
    ...
    private void inicializarTabla(boolean sucursalesActivas)
            throws IOException
    {
            ...
            throws Exception
    {
        if (tblSucursales.getSelectionModel().getSelectedItem() != null)
        {
            ...
            txtLongitud.setText(String.valueOf(
                    sucursalSeleccionada.getLongitud()));
            ...
            throws Exception
    {
        ...
        String url = "http://localhost:18835/my-spa/mapa.html?nombre=" + nom + "&domicilio=" + dom + "&lati=" + lat + "&long=" + lon;
        String acum = "";
    ...
    private ObservableList<Sucursal> obtenerDatos(boolean sucursalesActivas)
            throws IOException
    {
            ...
            filteredData.setPredicate(sucursal -> 
            {
                ...
                try
                {
                    ...
                    if (sucursal.getNombre().toLowerCase().contains(busqueda))
                        return true;
                    else if (sucursal.getDomicilio().toLowerCase().contains(
                            busqueda))
                        return true;
